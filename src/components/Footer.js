...
const Footer = () => {
  return (
      <div>
          ...
          <div className="container px-5 py-24 mx-auto flex md:items-center bg-slate-800 lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            ...
            <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
              <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10">
                  <li>
                    <a className="text-gray-400 hover:text-white">Sobre</a>
                  </li>
                  <li>
                    <a className="text-gray-400 hover:text-white">Skill</a>
                  </li>
                  <li>
                    <a className="text-gray-400 hover:text-white">Projeto</a>
                  </li>  
                  <li>
              ...
              <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10">
                  ...
                  <li>
                    <a className="text-gray-400 hover:text-white">Expressjs</a>
                  </li>
                  <li>
                    <a className="text-gray-400 hover:text-white">MongoDB</a>
                  </li>
                  <li>
                    <a className="text-gray-400 hover:text-white">Firebase</a>
                  </li>
                </nav>
              </div>
              <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <div className="bg-gray-800 bg-opacity-75">
            <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
              <p className="text-gray-400 text-sm text-center sm:text-left">© 2023 Carlos Nascimento —
                <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@carllos.nascimentto</a>
              </p>
