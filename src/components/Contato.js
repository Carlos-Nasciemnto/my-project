...
const Contato = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12 py-12">    
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-green-500">Contato</h1>
      <p className="text-center">
        Sinta-se a vontade para me chamar para assunto de alguma demanda ou particular.<br/>
        Seja ela de qualquer natureza, ou se preferi mande um email, ligue para o celular abaixo.
      </p>
    </div>
      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">          
            <label for="name" className="leading-7 text-sm text-gray-400">Nome</label>
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label for="message" className="leading-7 text-sm text-gray-400">Messagem</label>
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a className="text-indigo-400">acntonycar62@gmail.com</a>
          <p className="leading-normal my-5">Celular: 71 99316-1998</p>
