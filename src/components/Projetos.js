        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">          
          ...
          <div className="lg:flex-grow text-slate-200 md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              Projeto desenvolvido com objetivo de aprimorar os conhecimentos
              de HTML, CSS e JAVASCRIPT. E o objetivo  
              é acertar as palavras, além disso o sistema faz a 
              contagem de pontuação e identifica as letras já jogada.
            </p>          
          </div>                            
        </div>
      </section>
